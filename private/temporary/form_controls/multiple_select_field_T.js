...
import "./multiple_select_field_T.html";
...
Template.multiple_select_field_T.onCreated(() => { });


Template.multiple_select_field_T.rendered = () => {
...
Template.multiple_select_field_T.helpers({
  labelH() {
...
Template.multiple_select_field_T.events({
  submit(event) {
